...
|---|---|
| [architecture.md](architecture.md) | System components, project layout, and data flow |
| [agents.md](agents.md) | Per-agent responsibilities, tools, and I/O schemas |
| [workflow.md](workflow.md) | Step-by-step execution guide and graph topology |
| [tools.md](tools.md) | Tool implementations and data contracts |
